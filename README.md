...
quantity: Adds [arithmetic]
quantity: Subtracts [arithmetic]
quantity: Multiplies [arithmetic]
quantity: Divides [arithmetic]
quantity: Compares equal [comparison]
quantity: Compares unequal [comparison]
quantity: Compares less-than [comparison]
quantity: Compares less-equal [comparison]
quantity: Compares greater-than [comparison]
quantity: Compares greater-equal [comparison]
quantity: Compares, more extensive [comparison]
